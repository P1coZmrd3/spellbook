...
string[] poleSpellForms = pomocneMetody.PoleZTextu("data/spellform.txt");
string[] poleSpelTypes = pomocneMetody.PoleZTextu("data/spelltypes.txt");
...
while (true)
{
    ...
    if (input == "1")
    {
        ...
        newSpell.Name = pomocneMetody.VygenerujSpellname(poleSpellForms, poleSpelTypes);
